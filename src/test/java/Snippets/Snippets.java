...
public class Snippets {
    ...
    void browser_command_examples(){
        ...
        open("https://google.com"); //прямой путь открытия
        open("/customer/orders");  //дополнение к пути для запуска на разных средах
        ...
        Selenide.switchTo().frame("new"); //внутрь фрейма
        Selenide.switchTo().defaultContent();     //обратно из фрейма

        Selenide.switchTo().window("The Internet"); //переключение по имени окна
    }
